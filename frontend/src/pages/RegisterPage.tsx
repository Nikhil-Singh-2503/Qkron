...
import { AlertCircle, ArrowRight, CheckCircle2, User, Mail, Lock, Eye, EyeOff } from 'lucide-react';
                ...
                <Card className="relative bg-slate-900/80 backdrop-blur-xl border-slate-700/50 shadow-2xl shadow-blue-500/10 overflow-hidden">
                    ...
                    <CardHeader className="space-y-1 relative z-10">
                        ...
                        <CardDescription className="text-center text-slate-400">
                            Join QKron and start automating your tasks
                        </CardDescription>
                    </CardHeader>
                    ...
                    <form onSubmit={handleSubmit}>
                        <CardContent className="space-y-4 relative z-10">
                            ...
                            <div className="space-y-2">
                              ...
                              transition-all duration-300 ${focusedField === 'email' ? 'shadow-lg shadow-blue-500/10' : ''}`}
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className={`bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-500 pl-10 pr-10
                              focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20
                              transition-all duration-300 ${focusedField === 'confirmPassword' ? 'shadow-lg shadow-blue-500/10' : ''}`}
                                    />
                                    <button
                                        type="button"
                            ...
                            <label className="flex items-start gap-3 cursor-pointer group">
                                <div className="w-5 h-5 rounded border border-slate-600 bg-slate-800/50 mt-0.5
                        ...
                        <CardFooter className="flex flex-col space-y-4 relative z-10">
                            ...
                            >
                                {loading ? (
                                    <ButtonLoader size="sm" text="Creating account..." />
                                ) : (
                                    <>
                                        Create Account
